...
// overlay augmented reality compass
...
void thread_video ()
{
    ...
    while(isRunning)
    {
		...
		// put compass heading into buffer
		...
		// create 3d image from left and right images
...
void update(int value) { // main program loop
    ...
    // get compass for augmented reality, store into buffer    
    compass_heading_mutex.lock();
